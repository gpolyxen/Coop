...
void UBuildingMenuWidget::BedClicked(){SelectBuildPiece(EBuildPieceType::Bed);}void UBuildingMenuWidget::ChestClicked(){SelectBuildPiece(EBuildPieceType::WoodChest);}void UBuildingMenuWidget::WallClicked(){SelectBuildPiece(EBuildPieceType::WoodWall);}void UBuildingMenuWidget::GateClicked(){SelectBuildPiece(EBuildPieceType::WoodGate);}void UBuildingMenuWidget::FloorClicked(){SelectBuildPiece(EBuildPieceType::WoodFloor);}void UBuildingMenuWidget::StairsClicked(){SelectBuildPiece(EBuildPieceType::WoodStairs);}void UBuildingMenuWidget::PillarClicked(){SelectBuildPiece(EBuildPieceType::WoodPillar);}
