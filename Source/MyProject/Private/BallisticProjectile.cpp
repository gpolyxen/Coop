...
void ABallisticProjectile::InitializeProjectile(float D,float Dr,float W,float GravityScale,float LifeSeconds,AController* I){Damage=D;Drag=Dr;WindInfluence=W;DamageInstigator=I;Movement->ProjectileGravityScale=FMath::Max(0.f,GravityScale);SetLifeSpan(FMath::Max(1.f,LifeSeconds));}
